...
var config = require('../../config'),
    ...
    opts = {
        logFilePath: config.access.accountFile,
        timestampFormat: 'YYYY-MM-DD HH:mm:ss.SSS'
    },
    accessLogger = SimpleNodeLogger.createSimpleFileLogger(opts);
...
function accountInfo(req, res, next) {
    req.fwdResponse = req.fwdResponse.on('response', function(res) {
        accessLogger.info('| StatusCode=', req.fwdResponse.response.statusCode,
                           ' | UserId=', req.userId,
