...
var errors = {
    ...
    WrongXmlValidationResponse: function() {
        ...
        this.message = 'The system wasn\'t able to parse the XML obtained from the Keystone Proxy';
    },
    KeystoneProxyConnectionError: function(e) {
        this.name = 'KEYSTONE_PROXY_CONNECTION_ERROR';
        this.message = 'There was a connection error accessing the Keystone proxy: ' + e.message;
    },
    KeystoneProxyValidationError: function(message) {
        this.name = 'KEYSTONE_PROXY_VALIDATION_ERROR';
        this.message = 'The Keystone Proxy failed to make a decision due to the following error: ' + message;
    },
    KeystoneProxyAuthenticationError: function(e) {
        this.name = 'KEYSTONE_PROXY_AUTHENTICATION_ERROR';
        this.message = 'There was a connection error while authenticating to the Keystone Proxy: ' + e.message;
    },
