...
var errors = {
    ...
    ActionNotFound: function() {
        ...
        this.message = 'The system wasn\'t able to guess the action type or the headers';
    },
    ...
    KeystoneAuthenticationError: function(msg) {
        ...
        this.message = 'There was a connection error while authenticating to keystone_errors: ' + msg;
    },
    ...
    KeystoneSubserviceNotFound: function(name) {
        ...
        this.message = 'Could not find subservice with name [' + name + '] in keystone_errors.';
    },
    ...
    TargetServerError: function(msg) {
        ...
        this.message = 'There was an error redirecting the headers to the target server: ' + msg;
    }
};
