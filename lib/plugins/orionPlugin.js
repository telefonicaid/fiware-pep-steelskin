...
/**
 * Determines what is the requested action based on the headers information, knowing that it is a convenience operation.
 *
 * @param {Object} req           Incoming headers.
 * @param {Object} res           Outgoing response.
 */
...
/**
 * Middleware to calculate what Context Broker action has been received based on the path and the headers payload.
 *
 * @param {Object} req           Incoming headers.
 * @param {Object} res           Outgoing response.
 */
