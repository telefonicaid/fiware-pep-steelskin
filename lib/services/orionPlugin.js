...
function isConvenienceOperation(request) {
    return request.url.toLowerCase().match(/^\/ngsi(9|10)\/contextentities|^\/ngsi(9|10)\/contextentitytypes/) ||
        request.url.toLowerCase().match(/\/ngsi10\/contextsubscriptions|\/ngsi9\/contextavailabilitysubscriptions/);
}
