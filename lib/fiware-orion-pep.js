...
/**
 * Generic error handler for every headers that raises an error in the validation process. TODO: change the error code
...
function handleError(error, req, res, next) {
    ...
    switch (error.name) {
        case 'SyntaxError':
            logger.debug('Wrong JSON Syntax on headers: %s', error.body);
            code = 400;
            break;
